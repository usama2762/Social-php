        ...
        <div class="col-md-10 col-sm-10">
            <div class="rcontent">
               ...
               for($i = 1, $a = 1; $i < 7; $i++, $a+=2) { . 
                "<input type=\"radio\" name=\"slide_switch\" id=\"id".echo $i ."\"" . if($i == 1) echo . "\" checked=\"checked\" />" .
                "<label for=\"id".echo $i ."\"><img src=\"" . cell($row, 7+$i+$a) . "\" width=\"100\"/></label><img src=\"". cell($row, 7+$i+$a) ."\"/>
